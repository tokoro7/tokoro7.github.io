...
export function renderIndexPage(projects: readonly Project[]): string {
  const body = (
    <>
      <h1>
        Takeru Tokoro <span class="handle">/ tokoro7</span>
      </h1>
      ...
      <ul class="awards">
        <li>
          <span class="year">2023</span>「IVRC2023メタバース部門」, 総合優勝・特別審査員賞Voxel
          Kei賞, 作品名: "Hz"
        </li>
        <li>
          <span class="year">2021</span>「東京大学総長賞」, 大賞, 題目:
          "コロナ禍の中での「バーチャル東大」の構築および高校生のためのオープンキャンパスでの公開"{" "}
        </li>
      </ul>
      ...
      <h2>Skills</h2>
      <p class="skills">
        Unity, C#, VR / XR, iOS, Android, TypeScript, React, Next.js, Python, OpenAI API
      </p>

      <h2>Resume / 履歴書・職務経歴書</h2>
      <p>
        <a href="mailto:takerutkr0130@gmail.com">メール</a>でご連絡ください。
      </p>
    </>
  );
